...
hc <-read.csv('data/ucr_hatecrimes.csv')
...
## Aggregate Hate Crimes Data ##



## Merge all aggregated data with Shapes ##
select_year = 2016
df_year = filter(hg_counts, hg_counts['Year'] == select_year)[c('State', 'count_hg','count_hg_n',
                                                                'count_hg_i','count_hg_i_n')]
